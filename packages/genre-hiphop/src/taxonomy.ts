...
export const HIP_HOP_SUBGENRES: HipHopSubgenreEntry[] = [
  {
    ...
    label: "Boom Bap",
    description:
      "Hard-hitting drums with prominent kick and snare, sampled loops, gritty aesthetic",
    bpmRange: [85, 95],
    bpmDefault: 90,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Trap",
    description:
      "Rolling hi-hats, 808 bass, syncopated snare, dark atmospheres",
    bpmRange: [130, 170],
    bpmDefault: 150,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Drill",
    description:
      "Minimalist beats, sliding 808s, aggressive delivery, dark energy",
    bpmRange: [130, 160],
    bpmDefault: 145,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Old School",
    description:
      "Classic breakbeats, funky basslines, party-focused, call-and-response",
    bpmRange: [90, 110],
    bpmDefault: 100,
    era: "1980s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Gangsta Rap",
    description:
      "Street narratives, heavy bass, cinematic samples, raw storytelling",
    bpmRange: [80, 100],
    bpmDefault: 90,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    label: "G-Funk",
    description:
      "Synthesized P-funk samples, smooth grooves, whiny synths, laid-back flow",
    bpmRange: [90, 100],
    bpmDefault: 95,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    label: "East Coast",
    description:
      "Complex lyricism, dense wordplay, jazzy samples, boom bap foundation",
    bpmRange: [85, 100],
    bpmDefault: 92,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    description:
      "Slow heavy beats, trunk-rattling bass, chopped-and-screwed influence",
    bpmRange: [70, 85],
    bpmDefault: 78,
    era: "2000s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Crunk",
    description:
      "High-energy party anthems, repetitive call-outs, heavy bass, aggressive",
    bpmRange: [70, 90],
    bpmDefault: 80,
    era: "2000s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Hyphy",
    description:
      "Upbeat, frenetic energy, synth stabs, heavy kick, dance-oriented",
    bpmRange: [90, 115],
    bpmDefault: 105,
    era: "2000s",
  ...
  },
  {
    ...
    label: "Mumble Rap",
    description:
      "Melodic, slurred delivery, trap-influenced beats, vibe over lyrics",
    bpmRange: [130, 170],
    bpmDefault: 150,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Emo Rap",
    description:
      "Emotional lyrics, rock influences, melodic delivery, introspective themes",
    bpmRange: [140, 180],
    bpmDefault: 160,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Lo-fi Hip-Hop",
    description:
      "Chill, relaxed beats, vinyl crackle, jazz samples, study music aesthetic",
    bpmRange: [70, 90],
    bpmDefault: 80,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Jazz Rap",
    description:
      "Live jazz instrumentation, complex harmonies, sophisticated lyricism",
    bpmRange: [80, 105],
    bpmDefault: 92,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Conscious Rap",
    description:
      "Socially aware lyrics, political themes, intellectual content, message-driven",
    bpmRange: [85, 100],
    bpmDefault: 92,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    description:
      "Eclectic influences, experimental production, non-traditional song structures",
    bpmRange: [80, 110],
    bpmDefault: 95,
    era: "1990s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Cloud Rap",
    description:
      "Ethereal, dreamy beats, atmospheric production, laid-back delivery",
    bpmRange: [60, 90],
    bpmDefault: 75,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Phonk",
    description:
      "Cowbell-driven, Memphis rap influence, chopped vocals, lo-fi aesthetic",
    bpmRange: [60, 90],
    bpmDefault: 75,
    era: "2010s",
    characteristics: [
  ...
  },
  {
    ...
    label: "UK Drill",
    description:
      "Slidey 808s, sparse beats, off-beat hi-hats, aggressive UK slang",
    bpmRange: [135, 155],
    bpmDefault: 145,
    era: "2010s",
    characteristics: [
    ...
    vocalStyle:
      "gritty, rapid delivery with UK street slang and distinct rhythm",
  ...
  },
  {
    ...
    label: "Grime",
    description:
      "140BPM breakneck beats, synth stabs, UK garage influence, energetic flow",
    bpmRange: [135, 145],
    bpmDefault: 140,
    era: "2000s",
    characteristics: [
  ...
  },
  {
    ...
    label: "Afrobeats",
    description:
      "African percussion, rhythmic guitar, call-and-response, dance-friendly",
    bpmRange: [100, 125],
    bpmDefault: 112,
    era: "2010s",
    characteristics: [
    ...
    vocalStyle:
      "melodic, rhythmic delivery with sung hooks and African cadence",
  ...
  },
  {
    ...
    label: "Trap&B",
    description:
      "Trap beats with R&B melodies, sung verses, hybrid rap-sung delivery",
    bpmRange: [110, 150],
    bpmDefault: 130,
    era: "2010s",
    characteristics: [
    ...
    vocalStyle:
      "melodic rap-sung delivery with smooth transitions between rap and singing",
